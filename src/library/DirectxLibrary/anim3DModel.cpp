...
AnimModel::AnimModel(LPCTSTR filename, LPDIRECT3DDEVICE9 pDev,D3DXVECTOR3 _scale) : pDevice(pDev),m_vecScale(_scale),m_curAnimNo(0),m_AnimTime(0) {
...
void AnimModel::RenderMeshContainer(LPDIRECT3DDEVICE9 pDevice, MYMESHCONTAINER* pMeshContainer, MYFRAME* pFrame) {
...
void AnimModel::DrawFrame(LPDIRECT3DDEVICE9 pDevice,LPD3DXFRAME pFrameBase) {
