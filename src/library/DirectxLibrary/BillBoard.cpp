...
void CBillBoard::Draw(LPDIRECT3DDEVICE9 _pDevice,Texture _texture,D3DXVECTOR3 _pos,float _scale,FRECT _rect,D3DXMATRIX _attitude,D3DCOLOR _color)
{
	// テクスチャ座標に変換
...
void CBillBoard::DrawCC(LPDIRECT3DDEVICE9 _pDevice,Texture _texture,D3DXVECTOR3 _pos,float _scale,FRECT _rect,D3DXMATRIX _attitude,D3DCOLOR _color)
{
	// テクスチャ座標に変換
	float u1 = _rect.left / _texture.GetWidth();
	float u2 = _rect.right / _texture.GetWidth();
