...
public:
	...
	void Draw(LPDIRECT3DDEVICE9 _pDevice,Texture _texture,D3DXVECTOR3 _pos,float _scale,Vertex::FRECT _rect,D3DXMATRIX _attitude,D3DCOLOR _color);
	...
	void DrawCC(LPDIRECT3DDEVICE9 _pDevice,Texture _texture,D3DXVECTOR3 _pos,float _scale,Vertex::FRECT _rect,D3DXMATRIX _attitude,D3DCOLOR _color);
