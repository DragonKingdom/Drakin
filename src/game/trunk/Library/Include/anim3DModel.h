...
public:
	 ...
	 */
	AnimModel(LPCTSTR filename,D3DXVECTOR3 _scale);
...
private:
	...
	void RenderMeshContainer(MYMESHCONTAINER* ,MYFRAME* );	// メッシュコンテナのレンダリング
	void DrawFrame(LPD3DXFRAME );								// 再帰コード：フレームのレンダリング
